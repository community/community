...
comment_id = discussion.add_comment(body: summary).dig("data", "addDiscussionComment", "comment", "id")
...
Discussion.update_discussion(id: discussion.id, body: updated_body)
