...
Discussion = Struct.new(
  ...
  def self.all(owner: nil, repo: nil)
    ...
    searchquery = "repo:#{owner}/#{repo} is:unanswered is:open is:unlocked updated:<#{cutoff_date} category:\\\"Pull Requests\\\" label:Question"
  ...
  def self.to_be_closed(owner: nil, repo: nil)
    ...
    searchquery = "repo:#{owner}/#{repo} is:unanswered is:open is:unlocked updated:<#{cutoff_date}  category:\\\"Projects and Issues\\\" label:Question label:inactive"
  ...
  def self.to_remove_label(owner: nil, repo: nil)
    ...
    searchquery = "repo:#{owner}/#{repo} is:unanswered is:open category:\\\"Pull Requests\\\" label:Question label:inactive"
